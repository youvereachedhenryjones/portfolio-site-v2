          ...
          <div className="space-y-10">
            {timeline.map((item, i) => (
              <div key={i} className="relative pl-12 sm:pl-16">
                {/* Dot */}
                <div
                  className={`absolute left-2.5 sm:left-[18px] top-1.5 w-3 h-3 rounded-full border-2 ${
                    i === 0
            ...
            <div className="relative pl-12 sm:pl-16">
              <div className="absolute left-2.5 sm:left-[18px] top-1.5 w-3 h-3 rounded-full border-2 bg-navy border-steel" />
              <div className="bg-charcoal border border-electricBlue/10 rounded-xl p-5 hover:border-electricBlue/20 transition-all duration-300">
